...
--CEIL 올림
--FLOOP 내림
SELECT ABS(-45),FLOOR(3.14) FROM DUAL;
--MOD 나머지
...
--날짜 연산 가능
SELECT HIRE_DATE, HIRE_DATE +1, HIRE_DATE -1 FROM EMPLOYEES; --일자 기준으로 연산됨

SELECT FIRST_NAME, SYSDATE - HIRE_DATE FROM EMPLOYEES; --일수(입사한지 며칠)
SELECT FIRST_NAME, (SYSDATE - HIRE_DATE)/7 FROM EMPLOYEES; --입사 후 몇 주
SELECT FIRST_NAME, (SYSDATE - HIRE_DATE)/365 FROM EMPLOYEES; --입사 후 몇 년
...
SELECT ROUND(SYSDATE, 'YEAR'), TRUNC(SYSDATE, 'YEAR') FROM DUAL; --연 기준
