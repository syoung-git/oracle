--제약조건 (컬럼에 대한 데이터 수정, 삭제, 삽잉ㅂ 등 이상을 방지하기 위한 조건)
--PRIMARY KEY : 테이블 고유 키, 중복 X, NULL X, PK는 테이블에서 1개
--NOT NULL : NULL을 허용하지 않음
--UNIQUE KEY : 중복 X, NULL O
--FORIEGN KEY : 참조하는 테이블의 PK를 넣어 놓은 키, 중복 O, NULL O
--CHECK : 컬럼에 대한 데이터 제한
...
CREATE TABLE DEPTS(
    ...
    DEPT_DATE DATE          DEFAULT SYSDATE, --제약조건 아님.(컬럼의 기본값)
...
SELECT * FROM MY;
INSERT INTO MY VALUES ('AAA',1,'2018-07-01','M',1800);
INSERT INTO MY VALUES ('BBB',2,'2018-07-02','F',1900);
INSERT INTO MY VALUES ('CCC',3,'2018-07-03','M',2000);
INSERT INTO MY VALUES ('DDD',4,SYSDATE,'M',2000);
ROLLBACK;
--문제2.
--
...
CREATE TABLE BOOK(
    ...
    RET CHAR(1),
    CONSTRAINT BOOK_PK PRIMARY KEY(B_NO)
);
--ALTER TABLE BOOK ADD CONSTRAINT BOOK_PK PRIMARY KEY (B_NO);
ALTER TABLE BOOK ADD CONSTRAINT BOOK_CH CHECK (RET IN ('Y','N'));
SELECT * FROM BOOK;
